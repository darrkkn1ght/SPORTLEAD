...
export default function OurMandate() {
  return (
    <section className="bg-brand-off-white text-brand-navy py-24 relative z-10">
      <Container>
        ...
        <div className="grid lg:grid-cols-12 gap-12 mt-12">
          <div className="lg:col-span-8 lg:col-start-3 space-y-8">
            <blockquote className="border-l-4 border-brand-gold pl-8 py-2 my-12">
              <p className="text-3xl lg:text-4xl font-medium text-brand-navy-light leading-snug">
                "SportLead Africa exists to help close these institutional, operational and physical gaps."
              </p>
            </blockquote>
            
            <div className="prose prose-lg text-brand-grey max-w-none space-y-6">
              <p>
